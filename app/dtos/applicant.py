...
class ApplicantFields:
    ...
    age: fields.Integer = fields.Integer(
        title="Age", description="Student's age", min=15, max=22
    )
    ...
    family_size: fields.Boolean = fields.Boolean(
        title="Family size", description="Family size (true - <=3, false - >3)"
    )
    ...
    failures: fields.Integer = fields.Integer(
        title="Failures", description="Number of past class failures", min=1, max=4
    )
    ...
    nursery: fields.Boolean = fields.Boolean(
        title="Nursery", description="Attended nursery school (true - yes, false - no)"
    )
    ...
    absences: fields.Integer = fields.Integer(
        title="Absences", description="Number of school absences", min=0, max=93
    )
